...
! function(a) {
    ...
    if (b.DEFAULTS = {
            ...
            function h(a) {
                ...
                for (c in a)
                    if (a.hasOwnProperty(c)) {
                        var d = null;
                        b.opts.htmlAllowedStyleProps.length && (d = a[c].match(K)), "style" == c && d ? a[c] = g(d.join(";")) : c.match(J) || delete a[c]
                    }
                for (var e = "", f = Object.keys(a).sort(), h = 0; h < f.length; h++) c = f[h], e += a[c].indexOf('"') < 0 ? " " + c + '="' + a[c] + '"' : " " + c + "='" + a[c] + "'";
                return e
            }
            ...
            function l(a, c, d) {
                ...
                var g = a,
                    h = null;
                b.opts.fullPage && (g = b.html.extractNode(a, "body") || (a.indexOf("<body") >= 0 ? "" : a), d && (h = b.html.extractNode(a, "head") || "")), g = k(g, c), h && (h = k(h, c));
                var i = j(g, h, a);
                return f(i)
            }
                ...
                if (b.opts.htmlAllowComments || c.nodeType != Node.COMMENT_NODE)
                    ...
                    if (f)
                        for (var h = f.length - 1; h >= 0; h--) {
                            var i = f[h],
                                j = null;
                            b.opts.htmlAllowedStyleProps.length && (j = i.nodeValue.match(K)), "style" == i.nodeName && j ? i.nodeValue = g(j.join(";")) : i.nodeName.match(J) || c.removeAttribute(i.nodeName)
                        }
            ...
            function r(c, d, e, f) {
                ...
                return i.push("data-fr-.*"), i.push("fr-.*"), H = new RegExp("^" + h.join("$|^") + "$", "gi"), J = new RegExp("^" + i.join("$|^") + "$", "gi"), I = new RegExp("^" + b.opts.htmlRemoveTags.join("$|^") + "$", "gi"), K = b.opts.htmlAllowedStyleProps.length ? new RegExp("((^|;|\\s)" + b.opts.htmlAllowedStyleProps.join(":.+?(?=;|$))|((^|;|\\s)") + ":.+?(?=(;|')|$))", "gi") : null, c = l(c, p, !0)
            }
            ...
            function I(a, c, d) {
                b.selection.isCollapsed() || b.selection.remove();
                var e;
                if (e = c ? a : b.clean.html(a), e = e.replace(/\r|\n/g, " "), a.indexOf('class="fr-marker"') < 0 && (e = G(e)), b.core.isEmpty() && !b.opts.keepFormatOnDelete) b.el.innerHTML = e;
                else {
                    var f = b.markers.insert();
                    if (f) {
                        var g, h = b.node.blockParent(f);
                        if ((F(e) || d) && (g = b.node.deepestParent(f) || h && "LI" == h.tagName)) {
            ...
            function u(c) {
                var d = c.which;
                return !!(r(c) || d >= 37 && d <= 40 || !t(d) && d != a.FE.KEYCODE.DELETE && d != a.FE.KEYCODE.BACKSPACE && d != a.FE.KEYCODE.ENTER) || (A || (B = b.snapshot.get(), b.undo.canDo() || b.undo.saveStep()), clearTimeout(A), void(A = setTimeout(function() {
                    ...
                    if (b.node.hasClass(l, "fr-marker")) d = (d + 1) % 2;
                        ...
                        if (a(l).find(".fr-marker").length > 0) d = j(a(l), d, g, h);
                            ...
                            for (var m = a(l).find(g || "*"), n = m.length - 1; n >= 0; n--) {
                                var o = m[n];
                                b.node.isBlock(o) || b.node.isVoid(o) || !f(o, e(g, h)) || (o.outerHTML = o.innerHTML)
                            }
            ...
            pasteAllowedStyleProps: ["font-family", "font-size", "background", "color", "width", "text-align", "vertical-align", "background-color"],
            ...
            function d(a) {
                ...
                if (n = b.$win.scrollTop(), a && a.clipboardData && a.clipboardData.getData) {
                    var c = "",
                        d = a.clipboardData.types;
                    if (b.helpers.isArray(d))
                        for (var f = 0; f < d.length; f++) c += d[f] + ";";
                    else c = d;
                    if (o = "", p = a.clipboardData.getData("text/rtf"), /text\/html/.test(c) ? o = a.clipboardData.getData("text/html") : /text\/rtf/.test(c) && b.browser.safari ? o = p : /text\/plain/.test(c) && !this.browser.mozilla && (o = b.html.escapeEntities(a.clipboardData.getData("text/plain")).replace(/\n/g, "<br>")), "" !== o) return i(), a.preventDefault && (a.stopPropagation(), a.preventDefault()), !1;
                    o = null
                }
                e()
            }
            ...
            function e() {
                b.selection.save(), b.events.disableBlur(), o = null, q ? q.html("") : (q = a('<div contenteditable="true" style="position: fixed; top: 0; left: -9999px; height: 100%; width: 0; word-break: break-all; overflow:hidden; z-index: 9999; line-height: 140%;" tabIndex="-1"></div>'), b.$box.after(q), b.events.on("destroy", function() {
                    q.remove()
            ...
            function i() {
                ...
                null === o && (o = q.get(0).innerHTML, b.selection.restore(), b.events.enableBlur());
                var k = h(o),
                    m = b.events.chainTrigger("paste.beforeCleanup", o);
                if (m && "string" == typeof m && (o = m), !k) {
                    var n = b.opts.htmlAllowedStyleProps;
                    b.opts.htmlAllowedStyleProps = b.opts.pasteAllowedStyleProps, b.opts.htmlAllowComments = !1, o = b.clean.html(o, b.opts.pasteDeniedTags, b.opts.pasteDeniedAttrs), b.opts.htmlAllowedStyleProps = n, b.opts.htmlAllowComments = !0, o = l(o), o = o.replace(/\r|\n|\t/g, "");
                    var p = b.doc.createElement("div");
                    p.innerHTML = o, a.FE.copied_text && p.textContent.replace(/(\u00A0)/gi, " ").replace(/\r|\n/gi, "") == a.FE.copied_text.replace(/(\u00A0)/gi, " ").replace(/\r|\n/gi, "") && (o = a.FE.copied_html), o = o.replace(/^ */g, "").replace(/ *$/g, "")
                }
                o.indexOf("<body") >= 0 && (o = o.replace(/[.\s\S\w\W<>]*<body[^>]*>[\s]*([.\s\S\w\W<>]*)\s]*<\/body>[.\s\S\w\W<>]*/g, "$1"), o = o.replace(/([^>])\n([^<])/g, "$1 $2"));
                var r = !1;
                if (o.indexOf('id="docs-internal-guid') >= 0 && (o = o.replace(/^.* id="docs-internal-guid[^>]*>(.*)<\/b>.*$/, "$1"), r = !0), k && !b.wordPaste && (o = o.replace(/^\n*/g, "").replace(/^ /g, ""), 0 === o.indexOf("<colgroup>") && (o = "<table>" + o + "</table>"), o = f(o), o = l(o)), b.opts.pastePlain && (o = g(o)), m = b.events.chainTrigger("paste.afterCleanup", o), "string" == typeof m && (o = m), "" !== o) {
                    ...
                    var v = s.children;
                    if (1 == v.length && ["OL", "UL"].indexOf(v[0].tagName) >= 0 && (v[0].outerHTML = v[0].innerHTML), !r) {
                        var w = s.getElementsByTagName("br");
                        for (c = w.length - 1; c >= 0; c--) {
                            var x = w[c];
                            b.node.isBlock(x.previousSibling) && x.parentNode.removeChild(x)
                        }
                    }
                    if (b.opts.enter == a.FE.ENTER_BR)
                        for (d = s.querySelectorAll("p, div"), c = d.length - 1; c >= 0; c--) e = d[c], e.outerHTML = e.innerHTML + (e.nextSibling && !b.node.isEmpty(e) ? "<br>" : "");
                    else if (b.opts.enter == a.FE.ENTER_DIV)
                        for (d = s.getElementsByTagName("p"), c = d.length - 1; c >= 0; c--) e = d[c], e.outerHTML = "<div>" + e.innerHTML + "</div>";
            ...
            function e(c) {
                ...
                j.length ? b.accessibility.focusToolbarElement(j) : b.accessibility.focusToolbarElement(c)
            }
            ...
            function o(a, c, d) {
                ...
                if ("dropdown" == c.type) {
                    var m = '<div class="fr-dropdown-menu" role="listbox" aria-labelledby="' + k + '" aria-hidden="true"><div class="fr-dropdown-wrapper" role="presentation"><div class="fr-dropdown-content" role="presentation">';
            ...
            function h(a, c) {
                if (n[a]) {
                    var d = n[a].$modal,
                        e = d.data("instance") || b;
                    e.events.enableBlur(), d.hide(), m.hide(), e.$doc.find("body").removeClass("prevent-scroll fr-mobile"), d.removeClass("fr-active"), c || (b.accessibility.restoreSelection(e), b.events.trigger("modals.hide"))
                }
            }
            ...
            function h(a) {
                var c = null;
                c = "string" != typeof a ? a : x[a], c && b.node.hasClass(c, "fr-active") && (c.removeClass("fr-active fr-above"),
                    b.events.trigger("popups.hide." + a), b.$tb && (b.opts.zIndex > 1 ? b.$tb.css("zIndex", b.opts.zIndex + 1) : b.$tb.css("zIndex", "")), b.events.disableBlur(), c.find("input, textarea, button").filter(":focus").blur(), c.find("input, textarea").attr("disabled", "disabled"))
            }
            ...
            function m(c) {
                ...
                h && (d += g.frameElement.offsetLeft + g.frameElement.clientLeft), za = a(this), za.data("start-x", d), za.data("start-width", xa.width()), za.data("start-height", xa.height());
                var i = xa.width();
                ...
                b.events.$on(c, "dragover dragenter", ".fr-image-upload-layer", function() {
                    ...
                    if (this.files) {
                        ...
                        d.events.disableBlur(),
                            c.find("input:focus").blur(), d.events.enableBlur(), d.image.upload(this.files)
                    }
                    a(this).val("")
                })
            }
    ...
    a.FE.DEFAULTS.imageInsertButtons.push("imageManager"), a.FE.RegisterCommand("imageManager", {
        ...
        function c(c, d, e) {
            ...
            for (var h = a(g[0]).hasClass(c), i = 0; i < g.length; i++) a(g[i]).removeClass(f).toggleClass(c, !h),
                a(g[i]).hasClass("fr-temp-div") && a(g[i]).removeClass("fr-temp-div"), "" === a(g[i]).attr("class") && a(g[i]).removeAttr("class");
        ...
        function d() {
            ...
            for (var g = 0; g < f.length; g++) {
                d = f[g];
                var h = null;
                b.opts.linkAlwaysNoFollow && (h = "nofollow"), b.opts.linkAlwaysBlank && (h ? h += " noopener noreferrer" : h = "noopener noreferrer"), a(d).before(d.textContent.replace(a.FE.URLRegEx, "$1<a" + (b.opts.linkAlwaysBlank ? ' target="_blank"' : "") + (h ? ' rel="' + h + '"' : "") + ' href="$2">$2</a>$8')), d.parentNode.removeChild(d)
            }
        }

        function e() {
            b.events.on("paste.afterCleanup", function(c) {
                if (a.FE.URLRegEx.test(c)) return c.replace(a.FE.URLRegEx, "$1<a" + (b.opts.linkAlwaysBlank ? ' target="_blank"' : "") + (b.opts.linkAlwaysNoFollow ? ' rel="nofollow"' : "") + ' href="$2">$2</a>$8')
            }), b.events.on("keyup", function(c) {
                var e = c.which;
        ...
        function B(c) {
            ...
            i && (d += h.frameElement.offsetLeft + h.frameElement.clientLeft, e = c.clientY + h.frameElement.offsetTop + h.frameElement.clientTop), b.undo.canDo() || b.undo.saveStep(), pa = a(this), pa.data("start-x", d), pa.data("start-y", e), oa.show(), b.popups.hideAll(), M()
        }
        ...
        function c() {
            b.events.on("paste.beforeCleanup", function(a) {
                return b.paste.isWord(a) && (a = a.replace(/^\n*/g, "").replace(/^ /g, ""), 0 === a.indexOf("<colgroup>") && (a = "<table>" + a + "</table>"), a = v(a, b.paste.getRtfClipboard()), a = b.paste.removeEmptyTags(a)), a
            })
        }
        ...
        function h(a, b) {
            var c = a.cloneNode(!0);
            if (c.firstElementChild && "A" == c.firstElementChild.tagName && (c = c.firstElementChild), c.firstElementChild.remove(), ["H1", "H2", "H3", "H4", "H5", "H6"].indexOf(a.tagName) != -1) {
                var e = document.createElement(a.tagName.toLowerCase());
                e.setAttribute("style", a.getAttribute("style")), e.innerHTML = c.innerHTML, c.innerHTML = e.outerHTML
            }
            d(c, function(a) {
                return a.nodeType == Node.ELEMENT_NODE && t(a, null, b), !0
            });
            var f = c.innerHTML;
            return f = f.replace(/<!--[\s\S]*?-->/gi, "")
        }
        ...
        function i(a, b) {
            ...
            var e = d ? "ol" : "ul",
                ...
                m = a.parentNode;
            for (a.remove(), a = null; l && f(l);) {
                var n = l.previousElementSibling,
                    o = g(l);
                if (o > j) k += i(l, b).outerHTML;
                else {
                    if (o < j) break;
                    k += "</li><li>" + h(l, b)
                }
                if (j = o, l.previousElementSibling || l.nextElementSibling || l.parentNode) {
                    var p = l;
                    l = l.nextElementSibling, p.remove(), p = null
                } else l = n ? n.nextElementSibling : m.firstElementChild
            }
            k += "</li></" + e + ">";
            var q = document.createElement("div");
            q.innerHTML = k;
            var r = q.firstElementChild;
            return r
        }
        ...
        function k(a) {
            ...
            if (a.firstElementChild && (b = a.firstElementChild.tagName, ["SPAN", "STRONG", "B", "S", "EM", "U", "SUB", "SUP"].indexOf(b) != -1)) {
                ...
                d && (d = n(d), e.setAttribute("style", d)), e.innerHTML = a.innerHTML, a.innerHTML = e.outerHTML
            }
        }

        function l(c, d) {
            b.node.clearAttributes(c);
            for (var e = c.firstElementChild, g = 0, h = !1, i = null; e;) {
                e.firstElementChild && e.firstElementChild.tagName.indexOf("W:") != -1 && (e.innerHTML = e.firstElementChild.innerHTML), i = e.getAttribute("width"), i || h || (h = !0), g += parseInt(i, 10), (!e.firstChild || e.firstChild && e.firstChild.data == a.FE.UNICODE_NBSP) && (e.firstChild && e.firstChild.remove(), e.innerHTML = "<br>");
                for (var l = e.firstElementChild, p = 1 == e.children.length; l;) {
                    if ("P" == l.tagName && !f(l)) {
                        var r = null;
                        1 == l.children.length && l.firstElementChild && "SPAN" == l.firstElementChild.tagName ? (r = l.firstElementChild, p || (r = j(r, "div")), p ? o(e, l.getAttribute("style")) : o(r, l.getAttribute("style")), e.replaceChild(r, l)) : (r = j(l, p ? "span" : "div"), !p && r.getAttribute("align") && r.removeAttribute("align")), l = r, p && m(l)
                    }
                ...
                if (d) {
                    ...
                    d.td && o(e, d.td), k(e), q(e)
                }
                var w = e.getAttribute("style");
                w && (w = n(w), w && ";" != w.slice(-1) && (w += ";"));
                var x = e.getAttribute("valign");
                if (!x && w) {
                    var y = w.match(/vertical-align:.+?[; "]{1,1}/gi);
                    y && (x = y[y.length - 1].replace(/vertical-align:(.+?)[; "]{1,1}/gi, "$1"))
                }
                var z = null;
                if (w) {
                    var A = w.match(/text-align:.+?[; "]{1,1}/gi);
                    A && (z = A[A.length - 1].replace(/text-align:(.+?)[; "]{1,1}/gi, "$1")), "general" == z && (z = null)
                }
                var B = null;
                if (w) {
                    var C = w.match(/background:.+?[; "]{1,1}/gi);
                    C && (B = C[C.length - 1].replace(/background:(.+?)[; "]{1,1}/gi, "$1"))
                }
                var D = e.getAttribute("colspan");
                b.node.clearAttributes(e), D && e.setAttribute("colspan", D), x && (e.style["vertical-align"] = x), z && (e.style["text-align"] = z), B && (e.style["background-color"] = B), i && e.setAttribute("width", i), e = e.nextElementSibling
            }
            for (e = c.firstElementChild; e;) i = e.getAttribute("width"), h ? e.removeAttribute("width") : e.setAttribute("width", 100 * parseInt(i, 10) / g + "%"), e = e.nextElementSibling
        }
        ...
        function t(c, d) {
            var e = c.tagName,
                f = e.toLowerCase();
            c.firstElementChild && ("I" == c.firstElementChild.tagName ? j(c.firstElementChild, "em") : "B" == c.firstElementChild.tagName && j(c.firstElementChild, "strong"));
            var g = ["SCRIPT", "APPLET", "EMBED", "NOFRAMES", "NOSCRIPT"];
            if (g.indexOf(e) != -1) return c.remove(), !1;
            "O:P" == e && "&nbsp;" == c.innerHTML && (c.innerHTML = a.FE.INVISIBLE_SPACE);
            var h = -1,
                i = ["META", "LINK", "XML", "ST1:", "O:", "W:", "FONT"];
            for (h = 0; h < i.length; h++)
                if (e.indexOf(i[h]) != -1) return c.innerHTML ? (c.outerHTML = c.innerHTML, c.remove(), !1) : (c.remove(), !1);
            if ("TD" != e) {
                var p = c.getAttribute("class");
                if (d && p) {
                    p = n(p);
                    var r = p.split(" ");
                    for (h = 0; h < r.length; h++) {
                        var s = r[h],
                            t = [],
                            u = "." + s;
                        t.push(u), u = f + u, t.push(u);
                        for (var v = 0; v < t.length; v++) d[t[v]] && o(c, d[t[v]])
                    }
                }
                d && d[f] && o(c, d[f])
            }
            var w = ["P", "H1", "H2", "H3", "H4", "H5", "H6", "PRE"];
            if (w.indexOf(e) != -1) {
                k(c), q(c);
                var x = c.getAttribute("style"),
                    y = null;
                if (x) {
                    var z = x.match(/text-align:.+?[; "]{1,1}/gi);
                    z && (y = z[z.length - 1].replace(/(text-align:.+?[; "]{1,1})/gi, "$1"))
                }
                y ? c.setAttribute("style", y) : c.removeAttribute("style")
            }
            if ("P" == e && m(c), "TR" == e && l(c, d), c.getAttribute("class") && c.getAttribute("class").toLowerCase().indexOf("mso") != -1) {
                var A = n(c.getAttribute("class"));
        ...
        function u(a) {
            ...
            if (c.length)
                for (var d = c[0], e = d.innerHTML.match(/[\S ]+\s+{[\s\S]+?}/gi), f = 0; f < e.length; f++) {
                    var g = e[f],
        ...
        function v(c, e) {
            var g = new DOMParser,
                h = g.parseFromString(c, "text/html"),
                j = h.children[0],
                k = j.children[0],
                l = j.children[1],
                m = u(k);
            d(l, function(b) {
                if (b.nodeType == Node.TEXT_NODE && /\n/.test(b.data)) {
                    if (!/\S/.test(b.data)) return b.data == a.FE.UNICODE_NBSP || (b.remove(), !1);
                    b.data = b.data.replace(/\n/gi, " ")
                }
                return !0
            }), d(l, function(a) {
                return a.nodeType == Node.ELEMENT_NODE && "IMG" == a.tagName && s(a, e), !0
            }), d(l, function(a) {
                ...
                if (a.nodeType == Node.ELEMENT_NODE) {
                    if (f(a)) {
                        var b = a.parentNode,
                            ...
                            d = i(a, e),
                            g = null;
                        return g = c ? c.nextSibling : b.firstChild, g ? b.insertBefore(d, g) : b.appendChild(d), !1
                    }
                    return t(a, m, e)
                }
                return a.nodeType != Node.COMMENT_NODE || (a.remove(), !1)
            }), d(l, function(a) {
                if (a.nodeType == Node.ELEMENT_NODE) {
                    var b = a.tagName;
                    if (!a.innerHTML && ["BR", "IMG"].indexOf(b) == -1) {
                        for (var c = a.parentNode; c && (a.remove(), a = c, !a.innerHTML);) c = a.parentNode;
                        return !1
                    }
                    p(a)
                }
            ...
            return b.opts.htmlAllowedStyleProps = b.opts.pasteAllowedStyleProps, n = b.clean.html(n, b.opts.pasteDeniedTags, b.opts.pasteDeniedAttrs, !1), b.opts.htmlAllowedStyleProps = o, n
        }
        return {
            _init: c
        }
